...
L["Combat Mode (Tank)"] = true
L["opt_combatmode_tank_desc"] = "Optionally override the combat mode when playing as a Tank. If set to None, falls back to Combat Mode."
L["Combat Mode (Healer)"] = true
L["opt_combatmode_healer_desc"] = "Optionally override the combat mode when playing as a Healer. If set to None, falls back to Combat Mode."
L["Combat Mode (DPS)"] = true
L["opt_combatmode_damager_desc"] = "Optionally override the combat mode when playing as a Damager / DPS. If set to None, falls back to Combat Mode."
L["Wipe Mode"] = true
...
L["Role modes only in group"] = true
L["opt_rolemodes_onlygroup_desc"] = "Only switch to role-specific combat modes (Tank / Healer / DPS) when you are in a party or raid. When playing solo, the general Combat Mode will be used instead."
...
L["Fast updates"] = true
L["opt_fastupdates_desc"] = "Uses high-precision sub-second timers to calculate DPS and percentages continuously in real time. Increases CPU usage slightly."
